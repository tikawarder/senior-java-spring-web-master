...
public class SignTest {
	...
	private Map<String, String> files = new LinkedHashMap<>() {
		{
			...
			put("enhanced-buzz.jpg",
					"tsLUqkUtzqgeDMuXJMt1iRCgbiVw13FlsBm2LdX2PftvnlWorqxuVcmT0QRKenFMh90kelxXnTuT" + "\r\n" +
					"VOStU8eHRLS3P1qOLH6VYpzCGEJFQ3S2683gCmxq3qc0zr5kZV2VcgKWm+wKeMENyprr8HNZhLPy" + "\r\n" +
					"gtmzXeN9u6BpwUO9sKj7ImBvvv/qZ/Tht3hPbm5SrDK4XG7G0LVK9B8zpweXT/lT8pqqpYx4/h7D" + "\r\n" +
					"yE+L5bNHbtkvcu2DojgJ/pNg9OG+vTt/DfK7LFgCjody4SvZhSbLqp98IAaxS9BT6n0Ozjk4rR1l" + "\r\n" +
					"75QP5lbJbpQ9ThAebXQo+Be4QEYV/YXf07WXTQ==");
			put("rnd.jpg",
					"lM6498PalvcrnZkw4RI+dWceIoDXuczi/3nckACYa8k+KGjYlwQCi1bqA8h7wgtlP3HFY37cA81S" + "\r\n" +
					"T9I0X7ik86jyAqhhc7twnMUzwE/+y8RC9Xsz/caktmdA/8h+MlPNTjejomiqGDjTGvLxN9gu4qnY" + "\r\n" +
					"niZ5t270ZbLD2XZbuTvUAgna8Cz4MvdGTmE3MNIA5iavI1p+1cAN+O10hKwxoVcdZ2M3f7/m9LYl" + "\r\n" +
					"qEJgMnaKyI/X3m9mW0En/ac9fqfGWrxAhbhQDUB0GVEl7WBF/5ODvpYKujHmBAA0ProIlqA3FjLT" + "\r\n" +
					"LJ0LGHXyDgrgDfIG/EDHVUQSdLWsM107Cg6hQg==");
		}
	};
	...
	public void test_createDigitalSignature_givenJpgs_whenCreateSignatures_thenCorrectStringReturns() throws Exception {
		...
		for (String fileName : files.keySet()) {
			...
			//then
			Assert.assertEquals(files.get(fileName), result);
		}
	}
}
